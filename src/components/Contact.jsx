...
const Contact = () => {
  ...
  return (
    <div className="relative mt-20 mb-10 py-10 overflow-hidden">
      <div className="relative z-10 px-4 max-w-2xl mx-auto">
        ...
        <div className="bg-neutral-900/40 backdrop-blur-xl border border-white/5 p-8 rounded-3xl shadow-2xl">
          <form ref={form} onSubmit={sendEmail} className="space-y-6">
            ...
            <motion.textarea
              ...
              required
              className="w-full p-4 rounded-xl border border-white/10 bg-white/5 text-white placeholder-neutral-500 focus:border-purple-500 focus:bg-white/10 transition-all outline-none resize-y min-h-[120px]"
            ></motion.textarea>
